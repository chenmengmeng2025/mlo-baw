...
class WifiTxParameters
{
  public:
    ...
    /**
     * Get the number of MPDUs currently added for a receiver and TID.
     *
     * \param receiver the receiver MAC address
     * \param tid the QoS traffic identifier
     * \return the number of currently added MPDUs
     */
    uint32_t GetCurrentMpduNumber(Mac48Address receiver, uint8_t tid) const;
